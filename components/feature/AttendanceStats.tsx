...
export function AttendanceStats({
  ...
  const stats = [
    { label: 'Total', value: totalSessions, icon: 'event-note', gradient: ['#60A5FA', '#3B82F6'] as const },
    { label: 'Present', value: presentCount, icon: 'check-circle', gradient: ['#34D399', '#10B981'] as const },
    { label: 'Absent', value: absentCount, icon: 'cancel', gradient: ['#F87171', '#EF4444'] as const },
  ];
